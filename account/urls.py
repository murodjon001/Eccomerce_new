...
#                                                                 success_url="account/dashboard/password_reset_email_confirm",
...
#     path('password_reset_confirm/Mg/password_reset_complate/',
#          TemplateView.as_view(template_name="account/dashboard/reset_status.html"),name='password_reset_complate'),
#
#
#
#
